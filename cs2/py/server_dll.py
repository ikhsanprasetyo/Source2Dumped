...
class Schemas:
    ...
    class ServerDll:
        ...
        class Relationship_t:
            ...
            priority = 0x4 # int32
        class PF_NOISE_TYPE_PERLIN:
            pass
        class PF_INPUT_MODE_CLAMPED:
            pass
        class PF_RANDOM_MODE_CONSTANT:
            pass
        class PF_MAP_TYPE_DIRECT:
            pass
        class PF_INPUT_MODE_CLAMPED:
            pass
        class PF_NOISE_TYPE_PERLIN:
            pass
        class PVEC_TYPE_LITERAL_COLOR:
            pass
        class PF_ROUND_TYPE_NEAREST:
            pass
        class PF_RANDOM_MODE_CONSTANT:
            pass
        class PF_MAP_TYPE_DIRECT:
